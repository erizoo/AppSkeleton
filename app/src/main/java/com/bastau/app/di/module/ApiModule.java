...
import com.bastau.app.BuildConfig;
import com.bastau.app.data.network.ApiMethods;
import com.bastau.app.data.network.ServiceNetwork;
import com.bastau.app.data.network.ServiceNetworkImp;
...
public class ApiModule {
    ...
    HttpUrl provideHttpUrl() {
        return HttpUrl.parse("http://193.107.128.193:8000/");
    }
